...
public interface chatService {
	...
	public void delete(String id);//채팅방 삭제
	...
	public int ordercount(String roomId); //주문서 카운트
	public List<orderSheet> menucount(orderSheet os); //메뉴 개수
	public void menuinfor(ChatRoom vo); // 메뉴 정보 입력
	public List<ChatRoom> menulist(String roomId);//메뉴 정보 불러오기
	public void orderminus(orderSheet os); //메뉴 갯수 줄이기
	public List<menuinfor> menuinforList(String roomId);// 해당 방의 메뉴 정보 불러오기
	...
	public List<FileInfoDto> imgload(String roomId);//이미지 불러오기
